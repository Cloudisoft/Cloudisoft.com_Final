// src/components/CloudiCoreSection.tsx
    ...
    <section id="cloudicore" className="section space-y-12">
      ...
      <div className="space-y-6 text-center">
        ...
        <p className="max-w-2xl mx-auto text-slate-300 text-sm sm:text-base">
          An AI-powered business decision simulator that lets founders and managers
      ...
      <div className="card max-w-4xl mx-auto text-center space-y-3">
        ...
        <p className="text-sm sm:text-base text-slate-300">
          ...
          changes that by letting you simulate decisions before acting—preventing
          mistakes and optimizing results.
        </p>
      </div>
